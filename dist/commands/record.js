...
const record_1 = require("../formatters/record");
...
function createRecordCommand() {
    ...
    record
        ...
        try {
            ...
            const displayRecords = (0, record_1.formatRecords)(result.data);
    ...
    record
        ...
        try {
            ...
            const displayRecords = (0, record_1.formatRecords)(records);
