...
exports.EXAMPLE_SORTS = exports.EXAMPLE_FILTERS = exports.FILTER_OPERATORS = void 0;
 ...
 */
function filterByAttribute(attributeSlug, value) {
    return {
        [attributeSlug]: value,
    };
}
 ...
 */
function filterContains(attributeSlug, nestedField, searchText) {
    return {
        [attributeSlug]: {
            [nestedField]: {
                $contains: searchText,
 ...
 */
function filterEquals(attributeSlug, nestedField, value) {
    return {
        [attributeSlug]: {
            [nestedField]: {
                $eq: value,
 ...
 */
exports.EXAMPLE_SORTS = {
    // Sort by creation date, newest first
    newest_first: [{ attribute: 'created_at', direction: 'desc' }],
    // Sort by creation date, oldest first
    oldest_first: [{ attribute: 'created_at', direction: 'asc' }],
    // Sort by name (for objects that have a name attribute)
    by_name_asc: [{ attribute: 'name', direction: 'asc' }],
};
